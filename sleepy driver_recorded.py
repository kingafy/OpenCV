...
out = cv2.VideoWriter('testop.wav',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (frame_width,frame_height),1)
#time.sleep(1.0)
	...
	for rect in rects:
		...
		if ear < EYE_AR_THRESH:
			...
			if COUNTER >= EYE_AR_CONSEC_FRAMES:
				...
				#cv2.putText(frame, "GET UP!", (10, 30))
				cv2.putText(img = frame, text = 'GET UP', org = (1920,1080),fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale =0.7, color =(0, 0, 255))
